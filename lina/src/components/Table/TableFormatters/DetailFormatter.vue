<template>
  <div>
    <img v-if="icon && !formatterArgs.avatar" :src="icon" alt="icon" class="icon">
    <img v-if="icon && formatterArgs.avatar" :src="icon" alt="icon" class="avatar">
    <el-link
      v-if="!formatterArgs.avatar"
